...
public final class MavenProjectUtil {
    ...
    /**
     * Constructs the package name for the model repository layer.
     *
     * @param mavenProject The Maven project.
     * @return The package name for the model repository layer (e.g., {@code com.example.project.domain.repository}).
     */
